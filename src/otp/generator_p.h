...
namespace otp
{
    namespace generator
    {
        ...
        public:
            ...
            bool lookupSecret(const otp::secrets::SecretsAPIProvider::SecretAnswer& secret) const;
            bool writeSecret(const QString & secret, const otp::secrets::SecretsAPIProvider::SecretConfirmation& confirmation);
        ...
        public:
            ...
            bool secret(const otp::secrets::SecretsAPIProvider::SecretAnswer& secret) const;
