...
{
public:
    HOTPStoragePrivate(const QString& entryId, const QString& password, const QMap<QString,QVariant>& preset, QObject * parent = nullptr):
    ...
    HOTPStoragePrivate(const QString& password, const QMap<QString,QVariant>& preset, QObject * parent = nullptr):
