...
void TOTPGeneratorSamplesTest::testDefaults(void)
{
    ...
    map.insert(otp::storage::Storage::TOTP_TOKEN_EPOCH, QVariant());
    map.insert(otp::storage::Storage::TOTP_TOKEN_TIMESTEP, QVariant());
    ...
    stubs::storage::expect_param(paramReads, true, otp::storage::Storage::TOTP_TOKEN_EPOCH, QVariant());
    stubs::storage::expect_param(paramReads, true, otp::storage::Storage::TOTP_TOKEN_TIMESTEP, QVariant());
